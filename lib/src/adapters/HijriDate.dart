...
class HijriDate extends DateAdapter with DateFormatter {
  ...
  AbstractDate fromDateTime(DateTime dateTime) {
    var hd = UmmAlquraCalendar.fromDate(dateTime);
    return Date<HijriDate>(hd.hYear!, hd.hMonth!, hd.hDay!);
  }

  @override
  DateTime toDateTime(AbstractDate date) {
    var cal = UmmAlquraCalendar();
    return cal.hijriToGregorian(date.year, date.month, date.day);
  }
...
class UmmAlquraCalendar {
  ...
  DateTime julianToGregorian(julianDate) {
    ...
    // var wd = _gMod(julianDate + 1, 7) + 1; week day
    // print("Week day - $wd");
  ...
  UmmAlquraCalendar hDate(year, month, day) {
    this.hYear = year;
    this.hMonth = month;
    this.hDay = day;
  ...
  int _ummalquraDataIndex(int index) {
    index = index.clamp(0, ummAlquraDateArray.length).toInt();
    /*if (index < 0 || index >= ummAlquraDateArray.length) {
      throw "index $index is not between 1356 AH (14 March 1937 CE) to 1500 AH (16 November 2077 CE)";
    }*/
